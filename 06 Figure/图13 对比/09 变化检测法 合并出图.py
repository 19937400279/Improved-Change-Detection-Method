...
def wagner_cd_model(sm_path, vv_path, vh_path, picture_dir):
    ...
    axs[0].set_xlabel(r"Measured soil moisture $(\mathrm{cm}^3/\mathrm{cm}^3)$", fontsize=20)
    axs[0].set_ylabel(r"Retrieved soil moisture based on VH backscatter $(\mathrm{cm}^3/\mathrm{cm}^3)$", fontsize=20)
    ...
    evaluation_indicator = ' (a)  R:{:.3f}  R$^2$:{:.3f}  RMSE:{:.3f}  MAE:{:.3f}  MSE:{:.3f}'.format(r, R2, RMSE, MAE, MSE)
    ...
    axs[1].set_xlabel(r"Measured soil moisture $(\mathrm{cm}^3/\mathrm{cm}^3)$", fontsize=20)
    axs[1].set_ylabel(r"Retrieved soil moisture based on VV backscatter $(\mathrm{cm}^3/\mathrm{cm}^3)$", fontsize=20)
    ...
    evaluation_indicator = ' (b)  R:{:.3f}  R$^2$:{:.3f}  RMSE:{:.3f}  MAE:{:.3f}  MSE:{:.3f}'.format(r, R2, RMSE, MAE, MSE)
    axs[1].text(0.005, 0.975, evaluation_indicator, transform=axs[1].transAxes, fontdict={'size': '15'})
    fig.tight_layout()
    # plt.show()
    plt.savefig(picture_dir + '01 Wagner提出的CD反演法' + '.jpg',dpi=300)
...
def zribi_cd_model(ndvi_path, sm_path, vv_path, vh_path, picture_dir):
    ...
    MAE = mean_absolute_error(measured_sm.flatten(), inversion_sm_vh.flatten())
    MSE = mean_squared_error(measured_sm.flatten(), inversion_sm_vh.flatten())
    evaluation_indicator = ' (c)  R:{:.3f}  R$^2$:{:.3f}  RMSE:{:.3f}  MAE:{:.3f}  MSE:{:.3f}'.format(r, R2, RMSE, MAE, MSE)
    axs[0].text(0.005, 0.975, evaluation_indicator, transform=axs[0].transAxes, fontdict={'size': '15'})
    # 绘制子图2
    x = measured_sm.flatten()
    y = inversion_sm_vv.flatten()
    ...
    MAE = mean_absolute_error(measured_sm.flatten(), inversion_sm_vv.flatten())
    MSE = mean_squared_error(measured_sm.flatten(), inversion_sm_vv.flatten())
    evaluation_indicator = ' (d)  R:{:.3f}  R$^2$:{:.3f}  RMSE:{:.3f}  MAE:{:.3f}  MSE:{:.3f}'.format(r, R2, RMSE, MAE, MSE)
    axs[1].text(0.005, 0.975, evaluation_indicator, transform=axs[1].transAxes, fontdict={'size': '15'})
    fig.tight_layout()
    # plt.show()
    plt.savefig(picture_dir + '02 Zribi改进的CD反演法' + '.jpg',dpi=300)
...
def improved_cd_model(ndvi_path, sm_path, vv_path, vh_path, picture_dir):
    ...
    MAE = mean_absolute_error(measured_sm.flatten(), inversion_sm_vh.flatten())
    MSE = mean_squared_error(measured_sm.flatten(), inversion_sm_vh.flatten())
    evaluation_indicator = ' (e)  R:{:.3f}  R$^2$:{:.3f}  RMSE:{:.3f}  MAE:{:.3f}  MSE:{:.3f}'.format(r, R2, RMSE, MAE,
                                                                                                   MSE)
    axs[0].text(0.005, 0.975, evaluation_indicator, transform=axs[0].transAxes, fontdict={'size': '15'})
    # 绘制子图2
    x = measured_sm.flatten()
    ...
    MAE = mean_absolute_error(measured_sm.flatten(), inversion_sm_vv.flatten())
    MSE = mean_squared_error(measured_sm.flatten(), inversion_sm_vv.flatten())
    evaluation_indicator = ' (f)  R:{:.3f}  R$^2$:{:.3f}  RMSE:{:.3f}  MAE:{:.3f}  MSE:{:.3f}'.format(r, R2, RMSE, MAE,
                                                                                                   MSE)
    axs[1].text(0.005, 0.975, evaluation_indicator, transform=axs[1].transAxes, fontdict={'size': '15'})
    fig.tight_layout()
    # plt.show()
    plt.savefig(picture_dir + '03 本文改进的CD反演法' + '.jpg', dpi=300)
...
def plot_scatter(inversion_sm_vv_1, inversion_sm_vh_1, measured_sm_1,
    ...
    config = {"font.family": 'serif', "mathtext.fontset": 'stix', "font.serif": ['SimSun']}
    rcParams.update(config)
    plt.rcParams['figure.figsize'] = (18, 26)  # 绘图分辨率
    plt.rc('font', family='Times New Roman')
    ...
    axs[0][0].set_xlabel(r"Measured soil moisture $(\mathrm{cm}^3/\mathrm{cm}^3)$", fontsize=20)
    axs[0][0].set_ylabel(r"Retrieved soil moisture based on VH backscatter $(\mathrm{cm}^3/\mathrm{cm}^3)$", fontsize=20)
    ...
    evaluation_indicator = ' ( a )  R:{:.3f}  R$^2$:{:.3f}  RMSE:{:.3f}  MAE:{:.3f}  MSE:{:.3f}'.format(r, R2, RMSE, MAE,
                                                                                                   MSE)
    axs[0][0].text(0.01, 0.96, evaluation_indicator, transform=axs[0][0].transAxes, fontdict={'size': '19'})
    # 绘制子图2
    x = measured_sm_1.flatten()
    ...
    axs[0][1].set_xlabel(r"Measured soil moisture $(\mathrm{cm}^3/\mathrm{cm}^3)$", fontsize=20)
    axs[0][1].set_ylabel(r"Retrieved soil moisture based on VV backscatter $(\mathrm{cm}^3/\mathrm{cm}^3)$", fontsize=20)
    ...
    evaluation_indicator = ' ( b )  R:{:.3f}  R$^2$:{:.3f}  RMSE:{:.3f}  MAE:{:.3f}  MSE:{:.3f}'.format(r, R2, RMSE, MAE,
                                                                MSE)
    axs[0][1].text(0.01, 0.96, evaluation_indicator, transform=axs[0][1].transAxes, fontdict={'size': '19'})
    ...
    axs[1][0].set_xlabel(r"Measured soil moisture $(\mathrm{cm}^3/\mathrm{cm}^3)$", fontsize=20)
    axs[1][0].set_ylabel(r"Retrieved soil moisture based on VH backscatter $(\mathrm{cm}^3/\mathrm{cm}^3)$", fontsize=20)
    ...
    evaluation_indicator = ' ( c )  R:{:.3f}  R$^2$:{:.3f}  RMSE:{:.3f}  MAE:{:.3f}  MSE:{:.3f}'.format(r, R2, RMSE, MAE,
                                                                                                   MSE)
    axs[1][0].text(0.01, 0.96, evaluation_indicator, transform=axs[1][0].transAxes, fontdict={'size': '19'})
    # 绘制子图4
    x = measured_sm_2.flatten()
    ...
    axs[1][1].set_xlabel(r"Measured soil moisture $(\mathrm{cm}^3/\mathrm{cm}^3)$", fontsize=20)
    axs[1][1].set_ylabel(r"Retrieved soil moisture based on VV backscatter $(\mathrm{cm}^3/\mathrm{cm}^3)$", fontsize=20)
    ...
    evaluation_indicator = ' ( d )  R:{:.3f}  R$^2$:{:.3f}  RMSE:{:.3f}  MAE:{:.3f}  MSE:{:.3f}'.format(r, R2, RMSE, MAE,
                                                                                                   MSE)
    axs[1][1].text(0.01, 0.96, evaluation_indicator, transform=axs[1][1].transAxes, fontdict={'size': '19'})
    ...
    axs[2][0].set_xlabel(r"Measured soil moisture $(\mathrm{cm}^3/\mathrm{cm}^3)$", fontsize=20)
    axs[2][0].set_ylabel(r"Retrieved soil moisture based on VH backscatter $(\mathrm{cm}^3/\mathrm{cm}^3)$", fontsize=20)
    ...
    evaluation_indicator = ' ( e )  R:{:.3f}  R$^2$:{:.3f}  RMSE:{:.3f}  MAE:{:.3f}  MSE:{:.3f}'.format(r, R2, RMSE, MAE,
                                                                                                   MSE)
    axs[2][0].text(0.01, 0.96, evaluation_indicator, transform=axs[2][0].transAxes, fontdict={'size': '19'})
    # 绘制子图6
    x = measured_sm_3.flatten()
    ...
    axs[2][1].set_xlabel(r"Measured soil moisture $(\mathrm{cm}^3/\mathrm{cm}^3)$", fontsize=20)
    axs[2][1].set_ylabel(r"Retrieved soil moisture based on VV backscatter $(\mathrm{cm}^3/\mathrm{cm}^3)$", fontsize=20)
    ...
    evaluation_indicator = ' ( f )  R:{:.3f}  R$^2$:{:.3f}  RMSE:{:.3f}  MAE:{:.3f}  MSE:{:.3f}'.format(r, R2, RMSE, MAE,
                                                                                                   MSE)
    axs[2][1].text(0.01, 0.96, evaluation_indicator, transform=axs[2][1].transAxes, fontdict={'size': '19'})

    fig.tight_layout()
    # plt.show()
    plt.savefig(pic_dir + '各模型对比图' + '.jpg', dpi=300)
...
if __name__ == '__main__':
    ...
    # Wagner提出的CD反演法
    pic_dir = r'D:\05 Essay\小论文\论文图\图13 对比/'
